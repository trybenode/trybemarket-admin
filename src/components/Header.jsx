...
export default function Header() {
  ...
  return (
    <header className="w-full h-16 px-6 bg-white border-b border-gray-200 flex items-center justify-between shadow-sm">
      {/* Search Bar / Title */}
      <div className="flex items-center gap-4 flex-1">
        <div className="flex items-center gap-3 px-4 py-2 bg-gray-50 rounded-xl border border-gray-200 max-w-md w-full">
        ...
        <div className="relative">
          ...
          {open && (
            <div className="absolute top-14 right-0 w-48 bg-white shadow-lg rounded-xl border border-gray-200 py-2 z-50">
              <button className="w-full px-4 py-2 hover:bg-gray-50 text-left text-sm text-gray-700 flex items-center gap-3 transition-colors">
